        ...
        <section className="bg-white py-16">
            <div className="container mx-auto px-4">
                ...
                <div className="relative">
                                    ...
                                    flex flex-col'>
                                        ...
                                        <div className='border-t border-gray-700 pt-4 flex items-center justify-between'>
                                            ...
                                            <a 
                                                ...
                                                target='_blank'
                                                className='flex items-center justify-center gap-2 hover:bg-red-500 px-4 py-1 
                    ...
                    <button 
                        className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute
                        left-3 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 cursor-pointer'
                        onClick={scrollPrev}
                    >
                    ...
                    <button 
                        className='bg-white flex items-center justify-center rounded-full shadow-lg w-10 h-10 absolute
                        -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10 cursor-pointer'
                        onClick={scrollNext}
                    >
